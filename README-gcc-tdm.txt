...
REQUIRED BASE:
 * gcc-core (gcc-4.8.1-tdm-1-core)
 * binutils (binutils-2.23.1-1-mingw32-bin)
 * mingwrt (mingwrt-4.0.3-1-mingw32-dev, mingwrt-4.0.3-1-mingw32-dll)
 * w32api (w32api-4.0.3-1-mingw32-dev)

OPTIONAL:
 * gcc-c++ (gcc-4.8.1-tdm-1-c++) - C++ support
 * gcc-ada (gcc-4.8.1-tdm-1-ada) - Ada support
 * gcc-fortran (gcc-4.8.1-tdm-1-fortran) - Fortran support
 * gcc-objc (gcc-4.8.1-tdm-1-objc) - Objective-C/C++ support
 * gcc-openmp (gcc-4.8.1-tdm-1-openmp) - OpenMP support
...
>>>>> LOCAL FIXES AND CHANGES
 ...
 - Includes a patch to make x86 mingw32 default to i686 for basic CPU arch.
